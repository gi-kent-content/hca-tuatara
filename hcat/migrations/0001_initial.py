# Generated by Django 2.1 on 2019-09-25 23:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shared_google_sheet', models.URLField(blank=True, default=None, null=True)),
                ...
                ('staging_area', models.CharField(blank=True, default='', max_length=255)),
        ...
        migrations.AddField(
            model_name='organ',
            name='projects',
            field=models.ManyToManyField(blank=True, related_name='projects_organ_relationship', to='hcat.Project'),
        ),
        migrations.AddField(
            model_name='lab',
            name='projects',
